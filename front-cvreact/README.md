<div align="center">
  <br />
    <a href="https://youtu.be/0fYi8SGA20k?feature=shared" target="_blank">
      <img src="https://github.com/SpliiT Devhajdin/project_3D_developer_portfolio/assets/151519281/4722160a-8e61-403f-a905-728feae1f7e6" alt="Project Banner">
    </a>
  <br />
...
```bash
git clone git@github.com:SpliiT Devhajdin/project_3D_developer_portfolio.git
...
const experiences = [
  {
    ...
    company_name: "schiromenuiseries",
...
.violet-gradient {
  background: #ee4d4d;
  background: linear-gradient(-90deg, #ee4d4d 0%, rgba(60, 51, 80, 0) 100%);
  background: -webkit-linear-gradient(
    -90deg,
    #ee4d4d 0%,
    rgba(60, 51, 80, 0) 100%
